...
Expected Auxiliary Space: O(1)""",
        ...
        },
        {
            ...
            "Status":"Not Done",
            "Statement": """Given an array arr[] and an integer K where K is smaller than size of array, the task is to find the Kth smallest element in the given array. It is given that all array elements are distinct.
...
Expected Auxiliary Space: O(log(n))""",
        ...
        },
        {
            ...
            "Status":"Not Done",
            "Statement": """Given an array of size N containing only 0s, 1s, and 2s; sort the array in ascending order.
...
Expected Auxiliary Space: O(1)""",
        ...
        },
        {
            ...
            "Status":"Not Done",
            "Statement": """An array contains both positive and negative numbers in random order. Rearrange the array elements so that all negative numbers appear before all positive numbers.
